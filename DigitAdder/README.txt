Digit adder, can be ran in C or assembly (intel).
go in the file and type "make" in the terminal, WSL.
It will add 5 digits you give it, positive or negative and give you the total. Combines assembly and C files.
